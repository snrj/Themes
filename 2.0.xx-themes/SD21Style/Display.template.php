...
function template_main()
{
	...
	echo '
		...
		if ($message['can_modify'])
			echo '
							<span class="generic_icons regcenter" id="modify_button_', $message['id'], '" style="cursor: ', ($context['browser']['is_ie5'] || $context['browser']['is_ie5.5'] ? 'hand' : 'pointer'), '; " onclick="oQuickModify.modifyMsg(\'', $message['id'], '\')" ></span>';
