...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		echo '
				<div class="', $message['approved'] ? ($message['alternate'] == 0 ? 'windowbg' : 'windowbg') : 'approvebg', '">
...
// Maybe we can approve it, maybe we should?
	...
	if ($context['can_reply'] && !empty($options['display_quick_reply']))
	{
		...
		echo '<link rel="stylesheet" type="text/css" id="editor_css" href="' . $settings['default_theme_url'] . '/css/editor.css" />
