...
function template_main()
{
	...
	echo '
			<div id="forumposts">
				<div class="cat_bar">
					<h3 class="catbg">
						', $context['subject'], ' <span class="smalltext floatright">(', $txt['read'], ' ', $context['num_views'], ' ', $txt['times'], ')</span>
					</h3>
				</div>';
							...
							<div class="flow_hidden">
								<div class="keyinfo">
									...
									<h5 id="subject_', $message['id'], '">
										<a href="', $message['href'], '" rel="nofollow">', !empty($message['counter']) ? ' #' . $message['counter'] : '', '  ', $message['subject'], '</a>
									</h5>
