...
function template_info_center()
{
	...
	if ($context['user']['is_logged'])
	{
		if (!empty($context['user']['avatar']))
				...
				echo '<p class="centertext"><img class="img-circle"  src="'.$settings['images_url'].'/theme/default_avatar.png" alt="*"/></p>';
		echo '
				<ul class="reset">
	...
	elseif (!empty($context['show_login_bar']))
	{
		echo '
				...
				<form id="guest_form" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
					<input type="text" name="user" class="input_text anagir" placeholder="', $txt['username'], '" />
					<input type="password" name="passwrd" class="input_password anagir" placeholder="', $txt['password'], '"/>
					<select name="cookielength" class="anagir">
					...
					<input type="submit" value="', $txt['login'], '" class="button_submit floatright" />';
	...
	echo '</div><div class="side">
			...
			<form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
					<input type="text" name="search" value="" class="input_text anasearch" />&nbsp;
