...
function template_main()
{
	...
	{
		echo '<table class="table_list tborder">';
		...
		echo '
								<i class="fa fa-square"></i>', $category['link'], '
							</h3>
						</div>
					</td>
				</tr>
		...
		<tbody>
			<tr>
				<td class="catalt"></td>
				<td class="catalt">',$txt['board'],'</td>
				<td class="catalt">',$txt['latest_post'],'</td>
				<td class="catalt">',$txt['topics'],'</td>
				<td class="catalt">',$txt['message'],'</td>
			</tr>
		</tbody>';
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				if (!empty($board['children']))
				{
					...
					echo '
					<div id="board_', $board['id'], '_children" class="altblmler">
					', implode($children), '
					</div>';
				}
				...
				echo '
					...
					<td class="stats">
						<p>', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['board_topics'], '
						</p>
					</td>
