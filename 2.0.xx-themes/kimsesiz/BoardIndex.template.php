	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
				...
				<tr class="baslik">
					<td></td>
					<td>Başlık</td>
					<td class="stats">Konu İstatislik</td>
					<td>Son Mesaj</td>
				</tr>
			</tbody>';
		...
		echo '
			...
			{
				echo '
				<tr id="board_', $board['id'], '" class="blmshadow windowbg2">
...
function template_info_center()
{
	...
	echo '<div class="kabukistatislik">';
	if ($settings['show_stats_index'])
	{
		echo '
				<h4>
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=stats"><img class="icon" src="', $settings['images_url'], '/img/stats-icon.png" alt="', $txt['forum_stats'], '" /></a>
						', $txt['forum_stats'], '
					</span>
				</h4>
			<p>
