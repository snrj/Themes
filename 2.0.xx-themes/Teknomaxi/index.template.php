...
<body>	<img class="wallpaper" src="'. $settings['images_url']. '/theme/backdrop.png" alt="' . $context['forum_name'] . '" />';
}
...
function template_body_above()
{
    ...
    <div class="frame">
		...
		<div id="teknosearch" ><form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
					<input type="text" name="search" value="" class="input_text" />&nbsp;
					<input type="submit" name="submit" value="', $txt['search'], '" class="button_submit" />
					<input type="hidden" name="advanced" value="0" />
									</form>

			<img id="upshrink" src="', $settings['images_url'], '/upshrink.png" alt="*" title="', $txt['upshrink_description'], '" style="display: none;" /></div>
 <div class="teknomaxi">
          
       <ul class="tekno-maxi"><li></li>';
	...
	elseif (!empty($context['show_login_bar']))
	{
		echo '
				...
				<form id="guest_form" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
					...
					<input type="submit" value="', $txt['login'], '" class="button_submit" /></form><br />
	...
	echo '
			...
			<div class="news normaltext" style="float:right;">';
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li style="float:right;margin-top:-10px"><a href="http://smf.konusal.com" title="smf destek" target="_blank">Smf Destek</a></li>
		</ul>';
