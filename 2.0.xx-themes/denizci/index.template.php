...
<head>';
	...
	echo '<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/denizci.css" />';
...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
	<div class="logoheader">
		<div class="logo sol">
			<img src="',$settings['images_url'],'/img/logo.png" alt="" />
		</div>
	</div>';
	template_menu();
	mobile_menu();
	echo'<div class="ortaksm ortaarka ortak">';
}
