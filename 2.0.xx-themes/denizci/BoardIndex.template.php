...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		if ($category['can_collapse'])
			echo '<a class="collapse" href="', $category['collapse_href'], '"><i class="fa fa-sort-desc"></i></a>';
		...
		echo '
								<i class="fa fa-circle-o"></i>', $category['link'], '
							</h3>
						</div>
					</td>
				</tr>
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				<tr id="board_', $board['id'], '" class="windowbg2">
					<td class="icon windowbg"', !empty($board['children']) ? ' rowspan="1"' : '', '>
				...
				if (!empty($board['children']))
				{
					...
					<tr id="board_', $board['id'], '_children">
						<td colspan="4" class="children windowbg">
							<strong>', $txt['parent_boards'], '</strong>:<i class="fa fa-circle-o"></i>',implode('<i class="fa fa-circle-o"></i>', $children),'
						</td>
					</tr>';
				}
			}
	...
	echo '</div>
			<img class="solicon" id="upshrink_ic" src="', $settings['images_url'], '/kapa.png" alt="*" title="', $txt['upshrink_description'], '" style="display: none;" />
			...
			aSwapImages: [
				{
					...
					altExpanded: ', JavaScriptEscape($txt['upshrink_description']), ',
					srcCollapsed: smf_images_url + \'/kapa.png\',
					altCollapsed: ', JavaScriptEscape($txt['upshrink_description']), '
				}
			],
			oThemeOptions: {
...
function template_info_center()
{
	...
	if (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post'])))
	{
			...
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=recent"><i class="fa fa-pencil"></i></a>
						', $txt['recent_posts'], '
					</span>
				</h4>
			</div>
		...
		elseif (!empty($context['latest_posts']))
		{
			...
			foreach ($context['latest_posts'] as $post)
				echo '
					<dt><i class="fa fa-eercast"></i><strong>', $post['link'], '</strong> ', $txt['by'], ' ', $post['poster']['link'], ' (', $post['board']['link'], ')</dt>';
			echo '
				</dl>';
		}
		echo '
	...
	if ($settings['show_stats_index'])
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=stats"><i class="fa fa-cogs"></i></a>
						', $txt['forum_stats'], '
					</span>
				</h4>
			</div>
	...
	echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						', $context['show_who'] ? '<a href="' . $scripturl . '?action=who' . '">' : '', '<i class="fa fa-user-circle-o"></i>', $context['show_who'] ? '</a>' : '', '
						', $txt['online_users'], '
					</span>
				</h4>
			</div>
