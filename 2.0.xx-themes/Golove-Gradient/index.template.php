...
function template_init()
{
   ...
   /* Theme variants */
   $settings['theme_variants'] = array('black', 'orange', 'red', 'green', 'blue');
...
function template_body_above()
{
    ...
    </div><div id="teknonew"><p>', $txt['news'], ': ', $context['random_news_line'], '</p></div>';

	echo '</div>
<div id="wrapper" style="width:1024px;">
		<br class="clear" /><div id="header"><div class="frame">
			<h1 class="forumtitle">
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li>Theme Dizayn: <a href="http://smf.teknoromi.com" title="smf destek" target="_blank">Smf Destek</a></li>
		</ul>';
