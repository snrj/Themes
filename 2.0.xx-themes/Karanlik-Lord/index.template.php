...
<div class="top-section">';
  ...
  <button class="btn btn-sm btn-info dropdown-toggle" type="button" data-toggle="dropdown">', $txt['hello_member_ndt'], ' ', $context['user']['name'], '
...
function template_body_below()
{
	...
	', theme_copyright(), '',$txt['themeauthor'], '';
