...
function template_main()
{
	...
	<div class="pagesection">
		...
		<div class="floatright"><a href="', $scripturl . '?action=post;board=' . $context['current_board'] . '.0'.'"><img src="', $settings['images_url'], '/buttons/yenikonu.gif" alt="Yeni Konu" title="Yeni Konu" border="0"></a>
						...
						<a href="', $scripturl . '?action=markasread;sa=board;board=' . $context['current_board'] . '.0;sesc=' . $context['session_id'],'"><img src="', $settings['images_url'], '/buttons/okundu.gif" alt="Okundu Say" title="Okundu Say" border="0"></a></div>
	</div>';
	...
	<div class="tborder topic_table" id="messageindex">
		...
		if (!empty($context['topics']))
		{
			echo '
					...
					<th scope="col" class="gizle" width="10%"></th>
 					<th scope="col" class="gizle"width="10%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', $context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['started_by'], $context['sort_by'] == 'starter' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>

					<th scope="col" class="gizle" width="14%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=replies', $context['sort_by'] == 'replies' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['replies'], $context['sort_by'] == 'replies' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> / <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=views', $context['sort_by'] == 'views' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['views'], $context['sort_by'] == 'views' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			// Show a "select all" box for quick moderation?
			if (empty($context['can_quick_mod']))
				echo '
					<th scope="col" class="lefttext last_th gizle " width="22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			else
				echo '
					<th scope="col" class="lefttext gizle" width="22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			if ($topic['new'] && $context['user']['is_logged'])
					echo '
							<a href="', $topic['new_href'], '" id="newicon' . $topic['first_post']['id'] . '"><img style="float: left; height: 34px;" src="', $settings['lang_images_url'], '/new.png" alt="', $txt['new'], '" /></a>';
			...
			echo '
					...
					<td class="stats ', $color_class, '">
						<a href="http://www.google.com.tr/search?hl=tr&q=', $topic['first_post']['subject'], '&meta=" target="_blank" title="',$txt['efsane_google'],'"><img src="', $settings['images_url'], '/img/google.png" alt="',$txt['efsane_google'],'" /></a>
						<a href="http://www.bing.com/search?q=', $topic['first_post']['subject'], '" target="_blank" title="',$txt['efsane_bing'],'"><img src="', $settings['images_url'], '/img/bing.png" alt="',$txt['efsane_bing'],'" /></a>
						<a href="https://www.yandex.com.tr/search/?text=', $topic['first_post']['subject'], '" target="_blank" title="',$txt['efsane_yandex'],'"><img src="', $settings['images_url'], '/img/yandex.png" alt="',$txt['efsane_yandex'],'" /></a>
					</td>
					<td class="stats ', $color_class, '">
