...
function template_registration_agreement()
{
	...
	echo '
		<form action="', $scripturl, '?action=register" method="post" accept-charset="', $context['character_set'], '" id="registration">
			<div class="panel panel-info">
				<div class="panel-heading">', $txt['registration_agreement'], '</div>
				<div class="panel-body">', $context['agreement'], '</p></div>
			</div>
	...
	if ($context['show_coppa'])
		echo '
				<input type="submit" name="accept_agreement" value="', $context['coppa_agree_above'], '" class="btn btn-success" /><br /><br />
				<input type="submit" name="accept_agreement_coppa" value="', $context['coppa_agree_below'], '" class="btn btn-success" />';
	else
		echo '
				<input type="submit" name="accept_agreement" value="', $txt['agreement_agree'], '" class="btn btn-success" />';
...
function template_registration_form()
{
	...
	if (!empty($context['registration_errors']))
	{
		...
		<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			<strong>', $txt['registration_errors_occurred'], '</strong>
			<ul class="reset">';
