...
function template_generic_menu_dropdown_above()
{
   ...
   <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="multi-level-dropdown">
         <ul class="nav navbar-nav" id="dropdown_menu_', $context['cur_menu_id'], '">';
	...
	foreach ($menu_context['sections'] as $section)
	{
		...
		{
			echo '
			<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">', $section['title'] , '<b class="caret"></b></a>
		...
		foreach ($section['areas'] as $i => $area)
		{
			...
			echo '
					<li', (++$additional_items > 6) ? ' class="additional_items"' : ' class="dropdown-submenu"' ,'>';
			...
			if (!empty($area['subsections']))
			{
				...
				foreach ($area['subsections'] as $sa => $sub)
				{
					...
					echo '
							<li', (++$additional_items_sub > 6) ? ' class="additional_items"' : ' class="dropdown-submenu"' ,'>
