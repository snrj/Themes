...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
	...
	echo '</form>
		...
		<hr class="clear" style="background: linear-gradient(to right, rgba(255, 213, 0, 0.2) 0%, rgba(0, 0, 0, 0.5) 100%) repeat scroll 0 0 rgba(0, 0, 0, 0);"/>';
	...
	elseif (!empty($context['show_login_bar']))
	{
		...
		echo '<input type="hidden" name="hash_passwrd" value="" /><br /><label for="popupwindows" class="tekbutton" id="close">X</label>
					</label></form>';
	}
	echo '</div>';
	...
	if (!empty($settings['enable_news']))
		echo '<span style="float: right;">', $context['random_news_line'], '</span>';
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li>Trinity By <a href="http://demo.huutheme.com/" target="_blank">HuuTheme</a></li>
		</ul>';
