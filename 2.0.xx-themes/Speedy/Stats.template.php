...
function template_main()
{
	...
	<div id="statistics" class="main_section small">
		<div class="cat_bar">
				<h3 class="catbg">
			<i class="fa fa-pie-chart"></i> ', $context['page_title'], '
				</h3>
		</div>
		<div class="col-sm-12">
			<div class="col-sm-6">
	...
	echo '
			...
			<div class="cat_bar">
			<h3 class="catbg">
					<i class="fa fa-bar-chart"></i> ', $txt['general_stats'], '
			</h3>
			</div>
				<div class="roundframe">
						<dl class="stats">
	...
	echo '
		...
		<div class="col-sm-12">
			<div class="col-sm-6">
				<div class="cat_bar">
					<h3 class="catbg">
						<i class="fa fa-child"></i> ', $txt['top_posters'], '
					</h3>
				</div>
					<div class="roundframe">
	...
	echo '
			...
			<div class="col-sm-6">
				<div class="cat_bar">
					<h3 class="catbg">
							<i class="fa fa-inbox"></i> ', $txt['top_boards'], '
					</h3>
				</div>
					<div class="roundframe">
							<div class="poll-section">';
	...
	echo '
		...
		<div class="col-sm-12">
			<div class="col-sm-6">
				<div class="cat_bar">
					<h3 class="catbg">
						<i class="fa fa-reply-all"></i> ', $txt['top_topics_replies'], '
					</h3>
				</div>
					<div class="roundframe">				
							<div class="poll-section">';
	...
	echo '
			...
			<div class="col-sm-6">
				<div class="cat_bar">
					<h3 class="catbg">
							<i class="fa fa-eye"></i> ', $txt['top_topics_views'], '
					</h3>
				</div>
				<div class="roundframe">
						<div class="poll-section">';
	...
	echo '
		...
		<div class="col-sm-12">
			<div class="col-sm-6">
				<div class="cat_bar">
					<h3 class="catbg">
							<i class="fa fa-group"></i> ', $txt['top_starters'], '
					</h3>
				</div>
				<div class="roundframe">
						<div class="poll-section">';
	...
	echo '
			...
			<div class="col-sm-6">
				<div class="cat_bar">
					<h3 class="catbg">
							<i class="fa fa-history"></i> ', $txt['most_time_online'], '
					</h3>
				</div>
				<div class="roundframe">
						<div class="poll-section">';
	...
	echo '
		...
		<div class="col-sm-12">
			<div class="cat_bar">
					<h3 class="catbg">
						<i class="fa fa-history"></i> ', $txt['forum_history'], '
					</h3>
			</div>';
