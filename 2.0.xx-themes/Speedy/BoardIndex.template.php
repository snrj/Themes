...
function template_main()
{
	...
	<script type="text/javascript" async="" src="', $settings['default_theme_url'], '/scripts/fader.js?fin20"></script>
	<script type="text/javascript"><!-- // --><![CDATA[
		...
		var smfNewsFadeToggle = new smc_Toggle({
			...
			aSwapImages: [
				{
					sId: \'newsupshrink\',
					srcExpanded: smf_images_url + \'/collapse.gif?fin20\',
					altExpanded: ', JavaScriptEscape($txt['upshrink_description']), ',
					srcCollapsed: smf_images_url + \'/expand.gif?fin20\',
		...
		<div class="main_container">
			...
			foreach ($category['boards'] as $board)
			{
				...
				echo '
						...
						<p><span class="label label-default"><i class="fa fa-reply"></i> ', comma_format($board['posts']), ' </span> &nbsp; 
						 <span class="label label-default"><i class="fa fa-new_topic"></i>  '. comma_format($board['topics']) . ' </span>  
						</p>';
...
function template_info_center()
{
	...
	<div class="roundframe" id="info_center">
		<div class="title_bar">
			<h3 class="titlebg">
				<i class="fa fa-compress floatright" id="upshrink_ic" style="display: none;"></i>
