		...
		if ($context['show_bbc'] && $bbcContainer !== null)
		{
						...
						echo '
							{
								...
								sImage: ', JavaScriptEscape($tag['image']), ',
						...
						echo ',
							{
								...
								oOptions: {
									...
									\'Azure\': ', JavaScriptEscape($txt['Azure']), ',
									...
									\'FloralWhite\': ', JavaScriptEscape($txt['FloralWhite']), ',
									...
									\'MistyRose\': ', JavaScriptEscape($txt['MistyRose']), ',
									\'Bisque\': ', JavaScriptEscape($txt['Bisque']), '
								}
							}';
				}
				echo '
			...
			echo '
					...
					sButtonTemplate: ', JavaScriptEscape('
						<i id="%buttonId%" class="fa fa-%buttonSrc%" title="%buttonDescription%"></i>
					'), ',
