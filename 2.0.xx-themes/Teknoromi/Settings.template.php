...
function template_settings()
{
    ...
    array(
	    'id' => 'url_twitter',
	    'label' => $txt['admin_twitter_one'],
	    'type' => 'text',
    ),
    array(
	    'id' => 'active_google',
	    'label' => $txt['admin_google'],
    ),
    array(
	    'id' => 'url_google',
	    'label' => $txt['admin_google_one'],
	    'type' => 'text',
    ),
    array(
	    'id' => 'active_facebook',
	    'label' => $txt['admin_facebook'],
    ),
    array(
	    'id' => 'url_facebook',
	    'label' => $txt['admin_facebook_one'],
	    'type' => 'text',
    ),

    array(
	    'id' => 'active_youtube',
	    'label' => $txt['admin_youtube'],
    ),
    array(
	    'id' => 'url_youtube',
	    'label' => $txt['admin_youtube_one'],
	    'type' => 'text',
    ),
    array(
	    'id' => 'active_rss',
