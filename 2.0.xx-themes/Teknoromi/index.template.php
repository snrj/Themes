...
function template_body_above()
{
    ...
    <div class="headtop">
		...
		<a href="' . $scripturl . '"><img id="smflogo" src="' . $settings['images_url'] . '/logo.png" alt="torrent" title="torrent" /></a><br/>
<div class="teknomaxi">
    ...
    echo'	<div id="teknosearch" ><form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
