...
function template_main()
{
	...
	echo '
			<div id="forumposts">
				<div class="drop-shadowe liftede">
	...
	while ($message = $context['get_message']())
	{
		...
		echo '
				...
				echo '
					<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal' . $message['counter'].'">';
		...
		echo '</div>';
		echo '<div class="modal fade" id="myModal' . $message['counter'].'" role="dialog">
