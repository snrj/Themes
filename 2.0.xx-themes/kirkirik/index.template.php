...
function template_body_above()
{
	...
	if ($context['user']['is_logged'])
	{
		...
		echo '<div class="dropdown">
				  <button class="btn btn-danger dropdown-toggle" type="button" data-toggle="dropdown">', $txt['hello_member_ndt'], ' ', $context['user']['name'], '
	...
	{
		echo '<a class="btn btn-danger btn-info btn-sm" href="' . $scripturl . '?action=login">',$txt['login'],'</a>
		<a class="btn btn-danger btn-info btn-sm" href="' . $scripturl . '?action=register">',$txt['register'],'</a>';
	}
	echo '</div><div class="col-xs-6 text-right ortala">
				<form class="form-inline" id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '"><div class="form-group form-group-sm">
					...
					<input type="submit" name="submit" value="', $txt['search'], '" class="btn btn-danger btn-info btn-sm" />
	...
	<div class="menublm">
				<div class="col-sm-2">
					<h1 class="forumtitle text-left">
						<a class="logo" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? $context['forum_name'] : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" />', '</a>
					</h1>
				</div>
				<div class="col-sm-10 ortala">
				',template_menu(),'
				</div>
	</div>';
...
function template_body_below()
{
	...
	echo '</div></div>';
		...
		<div class="pull-left"><ul class="reset"><li class="copyright">', theme_copyright(), '</li></ul></div>
