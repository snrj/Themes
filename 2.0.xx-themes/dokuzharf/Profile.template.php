...
<div id="profileview" class="flow_auto">
	<div class="cat_bar">
		<h3 class="catbg">
			<span class="ie6_header floatleft"><span class="generic_icons members_request"></span>', $txt['summary'], '</span>
		</h3>
	</div>
	<div class="drop-shadow lifted">
		<div class="windowbg">
			...
			<div class="content flow_auto">
				<div class="username col-sm-6"><h4>', $context['member']['name'], ' <br/><span class="position">', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), '</span></h4>';
				...
				echo'</div><div class="col-sm-6  pull-right text-right"><ul class="reset">';
	...
	if ($context['member']['show_email'] === 'yes' || $context['member']['show_email'] === 'no_through_forum' || $context['member']['show_email'] === 'yes_permission_override')
		echo '
					<li><a href="', $scripturl, '?action=emailuser;sa=email;uid=', $context['member']['id'], '" title="', $context['member']['show_email'] == 'yes' || $context['member']['show_email'] == 'yes_permission_override' ? $context['member']['email'] : '', '" rel="nofollow"><span class="generic_icons mail"></span></a></li>';

	// Don't show an icon if they haven't specified a website.
	if ($context['member']['website']['url'] !== '' && !isset($context['disabled_fields']['website']))
		echo '
					<li><a href="', $context['member']['website']['url'], '" title="' . $context['member']['website']['title'] . '" target="_blank" class="new_win">', ($settings['use_image_buttons'] ? '<span class="generic_icons www"></span>' : $txt['www']), '</a></li>';
	...
	if (!empty($context['activate_message']) || !empty($context['member']['bans']))
	{
		...
		if (!empty($context['activate_message']))
			echo '
					<dt class="clear"><span class="alert alert-warning">', $context['activate_message'], '</span>&nbsp;(<a href="' . $scripturl . '?action=profile;save;area=activateaccount;u=' . $context['id_member'] . ';' . $context['session_var'] . '=' . $context['session_id'] . '"', ($context['activate_type'] == 4 ? ' onclick="return confirm(\'' . $txt['profileConfirm'] . '\');"' : ''), '>', $context['activate_link_text'], '</a>)</dt>';

		// If the current member is banned, show a message and possibly a link to the ban.
		if (!empty($context['member']['bans']))
		{
			echo '
					<dt class="clear"><span class="alert  alert-danger">', $txt['user_is_banned'], '</span>&nbsp;[<a href="#" onclick="document.getElementById(\'ban_info\').style.display = document.getElementById(\'ban_info\').style.display == \'none\' ? \'\' : \'none\';return false;">' . $txt['view_ban'] . '</a>]</dt>
		...
		<div class="topic">
			...
			if ($post['can_reply'] || $post['can_mark_notify'] || $post['can_delete'])
				...
				<div class="floatright">
					<ul class="reset smalltext pagination">';

			// If they *can* reply?
			if ($post['can_reply'])
				echo '
						<li><a href="', $scripturl, '?action=post;topic=', $post['topic'], '.', $post['start'], '"><span  class="quickbuttonss reply_button"></span> <span>', $txt['reply'], '</span></a></li>';

			// If they *can* quote?
			if ($post['can_quote'])
				echo '
						<li><a href="', $scripturl . '?action=post;topic=', $post['topic'], '.', $post['start'], ';quote=', $post['id'], '"><span  class="quickbuttonss quote_button"></span> <span>', $txt['quote'], '</span></a></li>';

			// Can we request notification of topics?
			if ($post['can_mark_notify'])
				echo '
						<li><a href="', $scripturl, '?action=notify;topic=', $post['topic'], '.', $post['start'], '"><span  class="quickbuttonss notify_button"></span> <span>', $txt['notify'], '</span></a></li>';

			// How about... even... remove it entirely?!
			if ($post['can_delete'])
				echo '
						<li><a href="', $scripturl, '?action=deletemsg;msg=', $post['id'], ';topic=', $post['topic'], ';profile;u=', $context['member']['id'], ';start=', $context['start'], ';', $context['session_var'], '=', $context['session_id'], '" onclick="return confirm(\'', $txt['remove_message'], '?\');"><span  class="quickbuttonss remove_button"></span> <span>', $txt['remove'], '</span></a></li>';
...
function template_editBuddies()
{
	...
	echo '
		<div class="title_bar">
			<h3 class="titlebg">
				<span class="ie6_header floatleft"><span  class="generic_icons starters"></span> ', $txt['editBuddies'], '</span>
			</h3>
		</div>
	...
	foreach ($context['buddies'] as $buddy)
	{
		echo '
			<tr class="', $alternate ? 'windowbg' : 'windowbg2', '">
				...
				<td align="center">', ($buddy['show_email'] == 'no' ? '' : '<a href="' . $scripturl . '?action=emailuser;sa=email;uid=' . $buddy['id'] . '" rel="nofollow"><span  class="generic_icons mail"></span></a>'), '</td>
				...
				<td align="center"><a href="', $scripturl, '?action=profile;area=lists;sa=buddies;u=', $context['id_member'], ';remove=', $buddy['id'], ';', $context['session_var'], '=', $context['session_id'], '"><span  class="generic_icons delete"></span></a></td>
			</tr>';
...
function template_editIgnoreList()
{
	...
	echo '
		<div class="title_bar">
			<h3 class="titlebg">
				<span class="ie6_header floatleft"><span  class="generic_icons starters"></span>', $txt['editIgnoreList'], '</span>
			</h3>
		</div>
		<table border="0" width="100%" cellspacing="1" cellpadding="4" class="table_grid" align="center">
			<tr class="catbg">
	...
	foreach ($context['ignore_list'] as $member)
	{
		echo '
			<tr class="', $alternate ? 'windowbg' : 'windowbg2', '">
				...
				<td align="center">', ($member['show_email'] == 'no' ? '' : '<a href="' . $scripturl . '?action=emailuser;sa=email;uid=' . $member['id'] . '" rel="nofollow"><span  class="generic_icons mail"></span></a>'), '</td>
				...
				<td align="center"><a href="', $scripturl, '?action=profile;u=', $context['id_member'], ';area=lists;sa=ignore;remove=', $member['id'], ';', $context['session_var'], '=', $context['session_id'], '"><span  class="generic_icons delete"></span></a></td>
			</tr>';
...
function template_showPermissions()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<span class="ie6_header floatleft"><span  class="generic_icons members"></span>', $txt['showPermissions'], '</span>
			</h3>
		</div>';
		...
		if (!empty($context['member']['permissions']['general']))
		{
			...
			foreach ($context['member']['permissions']['general'] as $permission)
			{
				...
				if ($permission['is_denied'])
					echo '
									<span class="alert alert-warning">', $txt['showPermissions_denied'], ':&nbsp;', implode(', ', $permission['groups']['denied']),'</span>';
				else
					echo '
				...
				<form action="' . $scripturl . '?action=profile;u=', $context['id_member'], ';area=permissions#board_permissions" method="post" accept-charset="', $context['character_set'], '">
					<div class="cat_bar">
						<h3 class="catbg"><span class="ie6_header floatleft">
							...
							<select class="form-control" name="board" onchange="if (this.options[this.selectedIndex].value) this.form.submit();">
...
function template_statPanel()
{
	...
	<div id="profileview">
		<div id="generalstats">
			<div class="cat_bar">
				<h3 class="catbg">
					<span class="ie6_header floatleft"><span class="generic_icons general"></span>
	...
	echo '
		<div id="activitytime" class="flow_hidden">
			<div class="cat_bar">
				<h3 class="catbg">
				<span class="ie6_header floatleft"><span class="generic_icons history"></span> ', $txt['statPanel_activityTime'], '</span>
				</h3>
			</div>
			<div class="windowbg2">
				<span class="topslice"><span></span></span>
	...
	echo '
		<div class="flow_hidden">
			<div id="popularposts">
				<div class="cat_bar">
					<h3 class="catbg">
						<span class="ie6_header floatleft"><span class="generic_icons replies"></span> ', $txt['statPanel_topBoards'], '</span>
					</h3>
				</div>
				<div class="windowbg2">
					<span class="topslice"><span></span></span>
	...
	echo '
			<div id="popularactivity">
				<div class="cat_bar">
					<h3 class="catbg">
					<span class="ie6_header floatleft"><span class="generic_icons replies"></span> ', $txt['statPanel_topBoardsActivity'], '</span>
					</h3>
				</div>
				<div class="windowbg2">
					<span class="topslice"><span></span></span>
...
function template_edit_options()
{
	...
	echo '
		<form action="', (!empty($context['profile_custom_submit_url']) ? $context['profile_custom_submit_url'] : $scripturl . '?action=profile;area=' . $context['menu_item_selected'] . ';u=' . $context['id_member'] . ';save'), '" method="post" accept-charset="', $context['character_set'], '" name="creator" id="creator" enctype="multipart/form-data" onsubmit="return checkProfileSubmit();">
			<div class="cat_bar">
				<h3 class="catbg">
					<span class="ie6_header floatleft"><span  class="generic_icons starters"></span>';
...
function template_profile_pm_settings()
{
	...
	echo '
								...
								<dd>
										<select class="form-control" name="pm_prefs" id="pm_prefs" onchange="if (this.value == 2 &amp;&amp; !document.getElementById(\'copy_to_outbox\').checked) alert(\'', $txt['pm_recommend_enable_outbox'], '\');">
						...
						<dl>
								...
								<dd>
										<select class="form-control" name="pm_receive_from" id="pm_receive_from">
	...
	echo '
								...
								<dd>
										<select class="form-control" name="pm_email_notify" id="pm_email_notify">
...
function template_profile_theme_settings()
{
	...
	if (empty($modSettings['disableCustomPerPage']))
	{
		echo '
							<li>
								...
								<select class="form-control" name="default_options[topics_per_page]" id="topics_per_page">
							...
							<li>
								...
								<select class="form-control" name="default_options[messages_per_page]" id="messages_per_page">
	...
	if (!empty($modSettings['cal_enabled']))
		echo '
							<li>
								...
								<select class="form-control" name="default_options[calendar_start_day]" id="calendar_start_day">
	...
	echo '
							<li>
								...
								<select class="form-control" name="default_options[display_quick_reply]" id="display_quick_reply">
							...
							<li>
								...
								<select class="form-control" name="default_options[display_quick_mod]" id="display_quick_mod">
...
function template_notification()
{
	...
	echo '
			<div class="cat_bar">
				<h3 class="catbg">
					<span class="ie6_header floatleft"><span class="generic_icons members"></span> ', $txt['profile'], '</span>
				</h3>
			</div>
	...
	echo '
						...
						<select class="form-control" name="notify_regularity" id="notify_regularity">
						...
						<select class="form-control" name="notify_types" id="notify_types">
...
function template_viewWarning()
{
	...
	echo '
		<div class="title_bar">
			<h3 class="titlebg">
				<span class="ie6_header floatleft"><span class="generic_icons members"></span> 
...
function template_issueWarning()
{
	...
	if (!$context['user']['is_owner'])
	{
		echo '
				...
				<dl class="settings">
					...
					<dd>
						<select class="form-control" name="warn_temp" id="warn_temp" disabled="disabled" onchange="populateNotifyTemplate();" style="font-size: x-small;">
	...
	foreach ($context['previous_warnings'] as $warning)
	{
		...
		if (!empty($warning['id_notice']))
			echo '
						<div class="floatright">
							<a href="', $scripturl, '?action=moderate;area=notice;nid=', $warning['id_notice'], '" onclick="window.open(this.href, \'\', \'scrollbars=yes,resizable=yes,width=400,height=250\');return false;" target="_blank" class="new_win" title="', $txt['profile_warning_previous_notice'], '"><span class="generic_icons search"></span> </a>
						</div>';
		echo '
					</td>
...
function template_deleteAccount()
{
	...
	echo '
		<form action="', $scripturl, '?action=profile;area=deleteaccount;save" method="post" accept-charset="', $context['character_set'], '" name="creator" id="creator">
			<div class="title_bar">
				<h3 class="titlebg">
					<span class="ie6_header floatleft"><span class="generic_icons members"></span> ', $txt['deleteAccount'], '</span>
				</h3>
			</div>';
	...
	if ($context['needs_approval'])
		echo '
					<div id ="profile_error" class="alert alert-danger">', $txt['deleteAccount_approval'], '</div>';

	// If the user is deleting their own account warn them first - and require a password!
	if ($context['user']['is_owner'])
	{
		echo '
					<div class="alert alert-warning">', $txt['own_profile_confirm'], '</div>
					<div>
	...
	{
		echo '
					<div class="alert alert-danger">', $txt['deleteAccount_warning'], '</div>';
		...
		if ($context['can_delete_posts'])
			echo '
					<div>
						...
						<select class="form-control" name="remove_type">
...
function template_profile_group_manage()
{
	...
	echo '
							...
							<dd>
								<select class="form-control" name="id_group" ', ($context['user']['is_owner'] && $context['member']['group_id'] == 1 ? 'onchange="if (this.value != 1 &amp;&amp; !confirm(\'' . $txt['deadmin_confirm'] . '\')) this.value = 1;"' : ''), '>';
	...
	if (!empty($context['member']['avatar']['allow_server_stored']))
	{
		echo '
								<div id="avatar_server_stored">
									<div>
										<select class="form-control" name="cat" id="cat" size="10" onchange="changeSel(\'\');" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'server_stored\');">';
		...
		echo '
									...
									<div>
										<select class="form-control" name="file" id="file" size="10" style="display: none;" onchange="showAvatar()" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'server_stored\');" disabled="disabled"><option></option></select>
									</div>
...
function template_profile_timeformat_modify()
{
	...
	echo '
							<dt>
								...
								<a href="', $scripturl, '?action=helpadmin;help=time_format" onclick="return reqWin(this.href);" class="help"><span class="generic_icons help"></span> </a>
								<span class="smalltext">&nbsp;', $txt['date_format'], '</span>
							</dt>
							<dd>
								<select class="form-control" name="easyformat" onchange="document.forms.creator.time_format.value = this.options[this.selectedIndex].value;" style="margin-bottom: 4px;">';
...
function template_profile_smiley_pick()
{
	...
	echo '
							...
							<dd>
								<select class="form-control" name="smiley_set" onchange="document.getElementById(\'smileypr\').src = this.selectedIndex == 0 ? \'', $settings['images_url'], '/blank.gif\' : \'', $modSettings['smileys_url'], '/\' + (this.selectedIndex != 1 ? this.options[this.selectedIndex].value : \'', !empty($settings['smiley_sets_default']) ? $settings['smiley_sets_default'] : $modSettings['smiley_sets_default'], '\') + \'/smiley.gif\';">';
...
function template_authentication_method()
{
	...
	echo '
		...
		<form action="', $scripturl, '?action=profile;area=authentication;save" method="post" accept-charset="', $context['character_set'], '" name="creator" id="creator" enctype="multipart/form-data">
			<div class="cat_bar">
				<h3 class="catbg">
					<span class="ie6_header floatleft"><span class="generic_icons members"></span> ', $txt['authentication'], '</span>
				</h3>
			</div>
						...
						<dd>
							...
							<dl id="auth_pass_div">
								...
								<dd>
									...
									<span id="smf_autov_pwmain_div" style="display: none;"><span class="generic_icons invalid"></span></span>
								</dd>
								<dt>
								...
								<dd>
									...
									<span id="smf_autov_pwverify_div" style="display: none;"><span class="generic_icons valid"></span></span>
								</dd>
							</dl>
						</dd>
					</dl>';
