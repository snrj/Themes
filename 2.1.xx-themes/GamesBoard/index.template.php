...
function template_body_above()
{
	...
	{
		echo '
		<form id="search_wrap" class="floatright" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
			<input id="main_search" type="search" name="search" value="" class="input_text">&nbsp;';
...
function template_menu()
{
	...
	echo '
					<ul class="dropmenu menu_nav" id="community_app_menu">';
