...
echo'
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
			...
			{
				echo '
				<div id="board_', $board['id'], '" class="snrjup_contain ', (!empty($board['css_class']) ? $board['css_class'] : '') ,'">
				...
				echo '<p class="board_description">', $board['description'] , '</p>';
