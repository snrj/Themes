...
function vision_top_section()
{
	global $context, $scripturl, $txt, $modSettings, $maintenance;
...
function vision_news()
{
	...
	if (!empty($settings['enable_news']) && !empty($context['random_news_line']))
		echo '
					<div class="newss">
						<p><span>', $txt['news'], ':</span>', $context['random_news_line'], '</p>
					</div>';
}
function vision_menu()
{
	global $txt;
...
function vision_footer()
{
	...
	// There is now a global "Go to top" link at the right.
		echo '
		<ul>
			<li class="floatright">' .$txt['themecopy'] .'<a href="', $scripturl, '?action=help">', $txt['help'], '</a> ', (!empty($modSettings['requireAgreement'])) ? '| <a href="' . $scripturl . '?action=help;sa=rules">' . $txt['terms_and_rules'] . '</a>' : '', ' | <a href="#top_section">', $txt['go_up'], ' &#9650;</a></li>
