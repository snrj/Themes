...
function template_init()
{
	...
	$settings['theme_variants'] = array('black', 'orange', 'red', 'green', 'blue', 'silver');
...
function template_body_above()
{
	...
	if (empty($context['theme_settings']['disable_user_variant']))
	 echo '<div class="snrjcolor floatright">
			  <span class="colorsec"></span>
			  <div class="snrjcolor-content">
					<a class="black" href="', $scripturl, '?variant=black" title="black"></a>
					<a class="red" href="', $scripturl, '?variant=red" title="red"></a>
					<a class="blue" href="', $scripturl, '?variant=blue" title="blue"></a>
					<a class="green" href="', $scripturl, '?variant=green" title="green"></a>
					<a class="orange" href="', $scripturl, '?variant=orange" title="orange"></a>
					<a class="silver" href="', $scripturl, '?variant=silver" title="silver"></a>
			  </div>
			</div>';
...
function template_body_below()
{
	...
	// There is now a global "Go to top" link at the right.
		echo '
		<ul>
			<li class="floatright"> <a href="http://smf.konusal.com/" title="smf destek" target="_blank"><span class="generic_icons current_theme"></span> Smf Destek</a> | <a href="', $scripturl, '?action=help">', $txt['help'], '</a> ', (!empty($modSettings['requireAgreement'])) ? '| <a href="' . $scripturl . '?action=help;sa=rules">' . $txt['terms_and_rules'] . '</a>' : '', ' | <a href="#top_section">', $txt['go_up'], ' &#9650;</a></li>
